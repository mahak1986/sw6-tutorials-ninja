...
#2.15 Verify the Todal "<price>"
  ...
  Scenario Outline: Verify Product Added To Shopping Cart SuccessFully
    ...
    Examples:
      ...
      | HTC Touch HD | Product 1  | £74.73  | 1   |
      | iPhone       | product 11 | £75.46  | 1   |
      | iPod Classic | product 20 | £74.73  | 1   |
      | MacBook      | Product 16 | £368.73 | 1   |
      | MacBook Air  | Product 17 | £736.23 | 1   |
      | Sony VAIO    | Product 19 | £736.23 | 1   |
